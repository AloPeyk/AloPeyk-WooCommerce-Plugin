...
<form class="awcshm-create-order-form">
	<table cellpadding="0" cellspacing="0" border="0" class="fixed striped wp-list-table awcshm-horizonal-table">
		<tbody>
			...
			<tr>
				<th width="130" valign="top"><?php echo __( 'Shipping Time', 'alopeyk-woocommerce-shipping' ); ?></th>
				<td valign="top">
			...
			<tr>
				<th width="130" valign="top"><?php echo __( 'Origin Description', 'alopeyk-woocommerce-shipping' ); ?></th>
				<td valign="top">
			...
			?>
			<tr>
				<th width="130" valign="top"><?php echo $label; ?></th>
				<td valign="top">
					<?php
						if ( $count == 0 ) {
