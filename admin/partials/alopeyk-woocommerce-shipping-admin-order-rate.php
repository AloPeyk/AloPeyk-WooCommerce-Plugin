...
<form class="awcshm-rate-order-form">
	...
	<div class="awcshm-rates-container">
		...
		<label for="awcshm-rate-checkbox-1"><?php echo esc_html__( 'Very Bad', 'alopeyk-shipping' ); ?></label>
		<input type="radio" name="rate" id="awcshm-rate-checkbox-2" value="2" required="required">
		<label for="awcshm-rate-checkbox-2"><?php echo esc_html__( 'Bad', 'alopeyk-shipping' ); ?></label>
		<input type="radio" name="rate" id="awcshm-rate-checkbox-3" value="3" required="required">
		<label for="awcshm-rate-checkbox-3"><?php echo esc_html__( 'Not Bad', 'alopeyk-shipping' ); ?></label>
		<input type="radio" name="rate" id="awcshm-rate-checkbox-4" value="4" required="required">
		<label for="awcshm-rate-checkbox-4"><?php echo esc_html__( 'Good', 'alopeyk-shipping' ); ?></label>
		<input type="radio" name="rate" id="awcshm-rate-checkbox-5" value="5" checked="checked" required="required">
		<label for="awcshm-rate-checkbox-5"><?php echo esc_html__( 'Very Good', 'alopeyk-shipping' ); ?></label>
		<?php if ( isset( $data['reasons'] ) && $reasons = (array) $data['reasons'] ) { ?>
		<div class="awcshm-radio-list-container">
			<p>
				<strong><?php echo esc_html__( 'Which of the following reasons make you decide to choose this score?', 'alopeyk-shipping' ); ?></strong>
			</p>
			<p>
				...
				<label class="awcshm-radio-list-item">
					...
					<textarea name="description" placeholder="<?php echo esc_html__( 'Description', 'alopeyk-shipping' ); ?>" rows="4" class="awcshm-rate-description" autofocus></textarea>
					<?php } ?>
				</label>
				<?php } ?>
			</p>
